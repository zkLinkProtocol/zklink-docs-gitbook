...
| Name         | Type                                | Description                                                                    |
|--------------|-------------------------------------|--------------------------------------------------------------------------------|
| accountId    | [Accountid](#AccountId)             | The Account id                                                                 |
| subAccountId | [SubAccountId](#SubAccountId)       | The sub-account id                                                             |
| slotId       | [SlotId](#SlotId)                   | slot id                                                                        |
| nonce        | [Nonce](#Nonce)                     | slot nonce                                                                     |
| baseTokenId  | [TokenId](#TokenId)                 | the base token, for example `BTC` in BTC/USDT pair                             |
| quoteTokenId | [TokenId](#TokenId)                 | The quote token, for example `USDT` in BTC/USDT pair                           |
| amount       | String                              | The string format of BigUint, the amount request in this order                 |
| price        | String                              | The string format of BigUint, the price request in this order                  |
| isSell       | u8                                  | 1:seller, 0: buyer                                                             |
| feeRates     | [u8, u8]                            | the fee of [maker, taker], 100 means 1.0%, the maximum 2.56%                   |
| hasSubsidy   | u8                                  | 1: true, 0: false. If maker has subsidy, the submitter will give maker subsidy |
| signature    | [ZkLinkSignature](#ZkLinkSignature) | The ZkLink signature of this order                                             |
